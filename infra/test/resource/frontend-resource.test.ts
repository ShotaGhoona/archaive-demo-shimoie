...
describe('FrontendResource', () => {
  describe('S3 + CloudFront Mode', () => {
    ...
    describe('Amplify properties should be undefined', () => {
      it('should have undefined amplifyApp property', () => {
        expect(frontendResource.amplifyApp).toBeUndefined();
      });

      it('should have undefined amplifyBranch property', () => {
        expect(frontendResource.amplifyBranch).toBeUndefined();
      });
    });
  });
  ...
  describe('Amplify Mode', () => {
    ...
    beforeEach(() => {
      ...
      frontendResource = new FrontendResource(stack, 'TestFrontend', {
        type: 'amplify',
        amplifyAppName: 'test-amplify-app',
    ...
    describe('Amplify App', () => {
      ...
      it('should export amplifyApp property', () => {
        expect(frontendResource.amplifyApp).toBeDefined();
      });
    ...
    describe('Amplify Branch', () => {
      ...
      it('should export amplifyBranch property', () => {
        expect(frontendResource.amplifyBranch).toBeDefined();
      });
    ...
    describe('S3/CloudFront properties should be undefined', () => {
      it('should have undefined bucket property', () => {
        expect(frontendResource.bucket).toBeUndefined();
      });

      it('should have undefined distribution property', () => {
        expect(frontendResource.distribution).toBeUndefined();
      });
    });
  });

  describe('Validation', () => {
    it('should throw error when bucketName is missing for s3-cloudfront type', () => {
      const app = new cdk.App();
      const stack = new cdk.Stack(app, 'TestStack');
      ...
      }).toThrow('bucketName is required when type is "s3-cloudfront"');
    });

    it('should throw error when amplifyAppName is missing for amplify type', () => {
      const app = new cdk.App();
      const stack = new cdk.Stack(app, 'TestStack');
      ...
      expect(() => {
        new FrontendResource(stack, 'TestFrontend', {
          type: 'amplify',
          // amplifyAppName is missing
        });
      }).toThrow('amplifyAppName is required when type is "amplify"');
    });
  });
